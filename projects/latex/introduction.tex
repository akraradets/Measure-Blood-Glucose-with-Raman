...
% Therefore, the measuring site, times, and model have to be chosen carefully.
...
% Furthermore, each site has a different skin structure, thus the appropriate measuring times should also be different.
% As a result, it is necessary to research the measuring sites and their optimal time in order to assess the direct glucose measurement and evaluate the sites based to their correlation with glycemic, Signal-to-noise ratio (SNR), and total measuring duration.
% The measuring times will be benchmarked with Apple Watch SpO2 sensor which uses a total measuring time of 15 seconds \citep{applewatch}.
...
% The experiment must be conducted to finalize and confirm the measuring times. 
...
% In the lab scenario, the measuring times can be any that yields the wanted result. 
% In contrast, a wearable does have a power and battery limit. 
% The measuring times should be selected to suit our goal.
...
% This study will require 15 subjects for data collection using the OGTT times.
